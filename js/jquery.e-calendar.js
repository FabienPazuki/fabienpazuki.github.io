(function ($) {
    ...
    $.fn.eCalendar.defaults = {
        ...
        events: [
            ...
            {title: 'Seminar in Copenhagen KU',
            description: '<a href="http://www.math.ku.dk/english/research/tfa/alg/ntseminar/">Niko Laaksonen: Lattice Point Counting in Sectors of Hyperbolic Space</a>',
            datetime: new Date(2015, 10, 6, 14)},
            {title: 'Seminar in Copenhagen KU',
            description: '<a href="http://www.math.ku.dk/english/research/tfa/alg/ntseminar/">Aftab Pande: An elementary construction of p-adic Hilbert Modular forms.</a>',
            datetime: new Date(2015, 10, 9, 16)},
            {title: 'Seminar in Chalmers (G&ouml;teborg)',
            description: '<a href="http://www.math.chalmers.se/~tamos/seminars.html">Per Salberger: Counting rational points on surfaces.</a>',
            ...
            datetime: new Date(2015, 11, 11, 14)},
